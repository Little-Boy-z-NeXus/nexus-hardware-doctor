...
REQUIRED_FILES = (
    ...
    "firmware/include/nexus_hardware_profile.generated.h",
    "firmware/scripts/nexus_profile_codegen.py",
    ...
    "nexus-hardware/README.md",
    "nexus-hardware/v1/nexus-hardware-profile.schema.json",
    "nexus-hardware/profiles/nexus-profile-goouuu-esp32-s3-ina226-l298n-jgb37-v1.json",
    "scripts/validate_contracts.py",
    "scripts/README.md",
    "nexus-k6-tests/README.md",
    "nexus-validate-hardware-profile.cmd",
